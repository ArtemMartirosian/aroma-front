export default function AboutPage() {
  const benefits = [
    ...
    "Админ-панель для обновления каталога без разработчика",
  ];
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 lg:px-8">
        ...
        <div className="space-y-5 text-lg leading-8 text-zinc-600">
          <p>
            ...
            наличие, объемы и связывается с магазином напрямую.
          </p>
          <p>
            В проекте нет онлайн-оплаты и корзины, поэтому интерфейс сфокусирован
            на каталоге, поиске и доверии к продукту.
          </p>
        </div>
      </section>
